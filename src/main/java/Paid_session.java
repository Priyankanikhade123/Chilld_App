...
public class Paid_session {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Session_Title.click();
        Session_Title.sendKeys("Sleeping session1");
        Thread.sleep(3000);
        ...
        Description.click();
        Description.sendKeys("One to One session sleeping coach");
        Thread.sleep(3000);
        ...
        WebElement Profile_Name = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.FrameLayout[@resource-id=\"android:id/content\"]/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.ImageView[1]")));
        Profile_Name.click();
        Thread.sleep(3000);
