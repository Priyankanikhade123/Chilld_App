...
public class pratikshabooking_group_session {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Book group session button
        WebElement Book_session_button = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.ImageView[@content-desc=\"Book a Group-Session\"]")));
        Book_session_button.click();
        Thread.sleep(5000);

        //Tap on the group session
        WebElement Group_session = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.view.View[@content-desc=\"Group Sessions\"]")));
        Group_session.click();
        ...
        WebElement Create_Button = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.view.View[@content-desc=\"Create Session\"]")));
            Create_Button.click();
        ...
        //Tap on the Confirm
//        WebElement Confirm = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.view.View[@content-desc=\"Confirm and Pay $252\"]")));
//        Confirm.click();
        ...
        try {
            WebElement confirmPayBtn = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("//android.view.View[contains(@content-desc, 'Confirm and Pay')]")
            ));
            confirmPayBtn.click();
            System.out.println("Clicked Confirm and Pay button.");
        } catch (Exception e) {
            System.out.println("❌ Could not find 'Confirm and Pay' button: " + e.getMessage());
        }
