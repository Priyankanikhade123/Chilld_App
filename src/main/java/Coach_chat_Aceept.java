...
public class Coach_chat_Aceept {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebElement Person_icon = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.view.View[@content-desc=\"No messages\n" +
                "No messages available yet\"]/android.view.View/android.widget.ImageView")));
        Person_icon.click();

        // Tap on the Accept the request for User
        WebElement Accept_request_for_user = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.ImageView[@content-desc=\"Pranita\n" +
                "request for chat connection\"]/android.widget.Button[2]")));
        Accept_request_for_user.click();

        //Tap to back button
        WebElement Back_to_Messages_screen = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//android.widget.Button[@content-desc=\"Back\"]")));
        Back_to_Messages_screen.click();
